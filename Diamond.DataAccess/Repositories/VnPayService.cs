	...
	public class VnPayService : IVnPayService
	{
		...
		public string CreatePaymentUrl(HttpContext context, VnPaymentRequestModel model)
		{
			...
			vnpay.AddRequestData("vnp_TxnRef", tick); // Mã tham chiếu của giao dịch tại hệ 
																		   //thống của merchant.Mã này là duy nhất dùng để phân biệt các đơn hàng gửi sang VNPAY.Không được trùng lặp trong ngày
		...
		public VnPaymentResponseModel PaymentExecute(IQueryCollection collections)
		{
			...
			return new VnPaymentResponseModel { Success = true,
			PaymentMethod=	"VnPay",
